...
})(["width:100%;display:flex;flex-direction:row;height:52px;border-bottom:1px solid rgba(211,211,211,0.5);&:hover{border-left:3px solid black;cursor:pointer;}"]);
...
})(["display:inline-block;width:30%;padding:10px;padding-left:12px;font-size:16px;font-weight:200;background-color:#f8f8ff;color:#000;@media (max-width:550px){font-size:13px;}"]);
...
//# sourceMappingURL=dashboard.js.5df68eb95b6e513d3623.hot-update.js.map