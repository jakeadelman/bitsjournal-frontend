...
})(["width:100%;display:flex;flex-direction:row;height:52px;transition:none;border-top:1px solid #d3d3d3;border-bottom:1px solid #d3d3d3;", " font-weight:200;border-left:10px solid #d3d3d3;border-radius:none;cursor:pointer;"], _shared_helpers__WEBPACK_IMPORTED_MODULE_3__["wideFont"]);
...
})(["display:inline-block;width:30%;padding:4px;padding-left:15px;font-size:14px;padding-top:9px;"]);
...
})(["display:inline-block;width:30%;padding:4px;padding-left:15px;padding-top:9px;font-size:14px;"]);
...
})(["display:inline-block;width:30%;padding:4px;padding-left:15px;font-size:14px;padding-top:10px;@media (max-width:1200px){font-size:13px;}@media (max-width:663px){padding-top:0px !important;}"]);
...
//# sourceMappingURL=dashboard.js.e92ac0250edc3087b638.hot-update.js.map