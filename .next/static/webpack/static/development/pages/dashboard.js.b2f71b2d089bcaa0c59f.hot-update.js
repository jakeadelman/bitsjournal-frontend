      ...
      for (var i = 0; i < data.fetchTradeHistory.length; i++) {
        ...
        if (i == data.fetchTradeHistory.length - 1) {
          for (var j = 0; j < fullRay.length; j++) {
            var dat = fullRay[j];
            dat.timestamp = Object(_Helpers_Functions_js__WEBPACK_IMPORTED_MODULE_5__["formatDateForRow"])(dat.timestamp);
            fullRay[j] = dat;
...
//# sourceMappingURL=dashboard.js.b2f71b2d089bcaa0c59f.hot-update.js.map