...
function () {
  ...
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(oldDat, hashtags) {
    var newTrades, oldTrades, tradeHashtags, j, oldTrade, m;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            newTrades = [];
            oldTrades = oldDat.fetchTradeHistory; //   for (let i = 0; i < oldTrades.length; i++) {

            tradeHashtags = oldTrades[i].hashtags.slice(",");
            console.log(tradeHashtags, "THIS TRADE HASHTAGS"); // console.log(tradeHashtags, "THIS TRADE HASHTAGS");
...
//# sourceMappingURL=dashboard.js.7de6eaf3eba61ce33648.hot-update.js.map