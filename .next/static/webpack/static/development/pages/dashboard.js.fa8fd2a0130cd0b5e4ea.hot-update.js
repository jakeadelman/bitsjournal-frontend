  ...
  _createClass(Example, [{
    ...
    value: function componentDidUpdate(prevProps) {
      if (!fast_deep_equal__WEBPACK_IMPORTED_MODULE_11___default()(this.props.filteredData, prevProps.filteredData)) {
        ...
        var newFullTrades = [];
        var firstFullTrades = this.createFullTrades(this.props.initData);
        firstFullTrades = firstFullTrades.fullTrades;

        if (this.props.filteredData == null) {
          console.log("was null", newFullTrades);
          this.setState({
...
//# sourceMappingURL=dashboard.js.fa8fd2a0130cd0b5e4ea.hot-update.js.map