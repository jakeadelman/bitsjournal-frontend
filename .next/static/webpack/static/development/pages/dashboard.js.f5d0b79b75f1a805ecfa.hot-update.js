...
})(["display:inline-block;width:30%;padding:5px;padding-left:12px;font-size:14px;@media (max-width:1200px){font-size:13px;}@media (max-width:663px){padding:none;}"]);
...
//# sourceMappingURL=dashboard.js.f5d0b79b75f1a805ecfa.hot-update.js.map