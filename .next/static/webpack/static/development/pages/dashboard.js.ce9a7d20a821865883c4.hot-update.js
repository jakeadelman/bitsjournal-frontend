  ...
  _createClass(_default, [{
        ...
        if (thisTradeHash != "undefined") {
          for (var j = 0; j < thisTradeHash.length; j++) {
            if (thisTradeHash[j] != "undefined") {
              var newArray = this.state.globalHash.push(thisTradeHash[j]);
              this.setState({
                globalHash: newArray
              });
            }
    ...
    value: function hashtagClicked(value) {
      ...
      if (this.state.globalHashActive[0] == undefined) {
        var newArray = this.state.globalHashActive.push(value);
        this.setState({
        ...
        if (index > -1) {
          var _newArray = this.state.globalHash.splice(index, 1);
      ...
      for (var i = 0; i < this.state.globalHashActive.length; i++) {
        ...
        if (i == this.state.globalHashActive.length - 1) {
          ...
          if (_index > -1) {
            var _newArray3 = this.state.globalHash.splice(_index, 1);
          ...
          var _newArray2 = this.state.globalHashActive.push(value);
...
//# sourceMappingURL=dashboard.js.ce9a7d20a821865883c4.hot-update.js.map