      ...
      try {
        ...
        if (diffMins >= 60 && diffMins < 60 * 10) {
          ...
          for (var _i = 0; _i < this.props.fivemin.length; _i++) {
            ...
            console.log(_compare, _compare2);
        ...
        if (diffMins >= 60 * 10 && diffMins < day * 4) {
          ...
          for (var _i2 = 0; _i2 < this.props.onehour.length; _i2++) {
            ...
            var additionalTime = 1000 * 60 * 60 * 10;

            if (_compare3 > additionalTime * -1 && _compare4 < additionalTime) {
              console.log(_compare3, _compare4);
        ...
        if (diffMins >= day * 4) {
          ...
          for (var _i3 = 0; _i3 < this.props.oneday.length; _i3++) {
            ...
            var _additionalTime = 1000 * 60 * 60 * 24 * 4;

            if (_compare5 > _additionalTime && _compare6 < _additionalTime) {
              console.log(_compare5, _compare6);
...
//# sourceMappingURL=dashboard.js.d4f1d04cedab01b92538.hot-update.js.map