  ...
  _createClass(_default, [{
    ...
    value: function hashtagClicked(value) {
      ...
      if (this.state.globalHashActive[0] == undefined) {
        ...
        if (index > -1) {
          var newArray = this.state.globalHash.splice(index, 1);
          this.setState({
            globalHash: newArray
          });
        }
      ...
      for (var i = 0; i < this.state.globalHashActive.length; i++) {
        ...
        if (i == this.state.globalHashActive.length - 1) {
          ...
          if (_index > -1) {
            var _newArray2 = this.state.globalHash.splice(_index, 1);

            this.setState({
              globalHash: _newArray2
            });
          }

          var _newArray = this.state.globalHashActive.push(value);

          this.setState({
            globalHashActive: _newArray
          });
          return;
        }
      }
...
//# sourceMappingURL=dashboard.js.a46a05b2fe40bbfc145d.hot-update.js.map