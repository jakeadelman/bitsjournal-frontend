...
function (_React$Component2) {
  ...
  _createClass(Comp, [{
    ...
    value: function hashtagClicked(value) {
      console.log(value);
      console.log(this.state.globalHashActive[0] == undefined);
      ...
      for (var i = 0; i < this.state.globalHashActive.length; i++) {
        ...
        if (this.state.globalHashActive.length == 0) {
          this.state.globalHashActive.push(value);
          return;
        }
...
//# sourceMappingURL=dashboard.js.1b2f112985a41ce08eec.hot-update.js.map