...
})(["width:100%;display:flex;flex-direction:row;height:52px;&:hover{transition:none;border-left:1px solid black;cursor:pointer;}"]);
...
})(["display:inline-block;width:30%;padding:10px;padding-left:12px;font-size:15px;background-color:#f8f8ff;color:#000;@media (max-width:550px){font-size:13px;}"]);
...
//# sourceMappingURL=dashboard.js.224f091d6dcddbdfb22b.hot-update.js.map