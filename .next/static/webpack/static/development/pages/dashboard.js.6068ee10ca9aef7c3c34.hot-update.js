      ...
      for (var i = 0; i < data.fetchTradeHistory.length; i++) {
        ...
        if (i == data.fetchTradeHistory.length - 1) {
          for (var j = 0; j < fullRay.length; j++) {
            var dat = fullRay[j];
            fullRay[j].timestamp = Object(_Helpers_Functions_js__WEBPACK_IMPORTED_MODULE_5__["formatDateForRow"])(dat.timestamp);
...
//# sourceMappingURL=dashboard.js.6068ee10ca9aef7c3c34.hot-update.js.map