        ...
        if (each.side == "Buy") {
          ...
          var annotationPropsDown = {
            ...
            y: function y(_ref2) {
              ...
              // yScale.range()[0] *
              var val = Object(_helpers__WEBPACK_IMPORTED_MODULE_8__["findYValSell"])(_this.state.yRangeNums[0], _this.state.yRangeNums[1], each.price);
              console.log("THIS VAL", val, yScale.range()[1]);
              return val;
            },
            onClick: console.log.bind(console),
            tooltip: function tooltip(d) {
...
//# sourceMappingURL=dashboard.js.84e014339a68d0fc7d2d.hot-update.js.map