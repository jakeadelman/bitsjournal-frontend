      ...
      try {
        ...
        if (diffMins >= 60 && diffMins < 60 * 10) {
          ...
          for (var _i = 0; _i < this.props.fivemin.length; _i++) {
            ...
            var additionalTime = 1000 * 60 * 60;

            if (_compare > additionalTime * -1 && _compare2 < additionalTime) {
        ...
        if (diffMins >= 60 * 10 && diffMins < day * 4) {
          ...
          for (var _i2 = 0; _i2 < this.props.onehour.length; _i2++) {
            ...
            var _additionalTime = 1000 * 60 * 60 * 10;

            if (_compare3 > _additionalTime * -1 && _compare4 < _additionalTime) {
        ...
        if (diffMins >= day * 4) {
          ...
          for (var _i3 = 0; _i3 < this.props.oneday.length; _i3++) {
            ...
            var _additionalTime2 = 1000 * 60 * 60 * 24 * 4;

            if (_compare5 > _additionalTime2 * -1 && _compare6 < _additionalTime2) {
              // console.log(compare1, compare2);
...
//# sourceMappingURL=dashboard.js.b5870613e9872187d721.hot-update.js.map