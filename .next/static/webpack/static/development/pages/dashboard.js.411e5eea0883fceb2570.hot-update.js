...
function (_React$Component2) {
  ...
  //   this.state.globalHashActive.push()
  // }
        ...
        if (thisTradeHash != "undefined") {
          for (var j = 0; j < thisTradeHash.length; j++) {
            if (thisTradeHash[j] != "undefined") {
              ...
              this.state.globalHash.push(thisTradeHash[j]); // console.log(this.props.store.globalHash);
            }
          }
        }
      }
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_1__["Query"], {
        ...
        if (data.checkApiKey == false) {
          ...
          return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Wrapper, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(ChartWrapper, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(TopHashtagDiv, null, console.log(_this3.state.globalHashActive), _this3.state.globalHashActive[0] == "all" ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(TopHashtagIndividualActive, null, "#all") : react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(TopHashtagIndividual, null, "#all"), _this3.state.globalHashActive.map(function (hash) {
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(TopHashtagIndividualActive, null, "#", hash);
...
var TopHashtagDiv = styled_components__WEBPACK_IMPORTED_MODULE_5__["default"].div.withConfig({
  displayName: "FetchQuery__TopHashtagDiv",
  componentId: "sc-1g6l220-0"
})(["display:flex;flex-direction:row;"]);
var TopHashtagIndividual = styled_components__WEBPACK_IMPORTED_MODULE_5__["default"].div.withConfig({
  displayName: "FetchQuery__TopHashtagIndividual",
  componentId: "sc-1g6l220-1"
})(["background:#f8f8ff;color:#000;padding:8px;margin:10px;border-radius:2px;:hover{cursor:pointer;}"]);
var TopHashtagIndividualActive = styled_components__WEBPACK_IMPORTED_MODULE_5__["default"].div.withConfig({
  displayName: "FetchQuery__TopHashtagIndividualActive",
  componentId: "sc-1g6l220-2"
})(["background:#212528;color:#fff;padding:8px;margin:10px;border-radius:2px;:hover{cursor:pointer;}"]);
...
//# sourceMappingURL=dashboard.js.411e5eea0883fceb2570.hot-update.js.map