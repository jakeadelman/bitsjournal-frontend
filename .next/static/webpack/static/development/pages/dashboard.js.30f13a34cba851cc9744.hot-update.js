...
})(["width:100%;display:flex;flex-direction:row;height:52px;font-weight:500;", " &:hover{transition:none;border-left:2px solid #d3d3d3;cursor:pointer;}"], _shared_helpers__WEBPACK_IMPORTED_MODULE_3__["wideFont"]);
...
})(["width:100%;display:flex;flex-direction:row;height:52px;font-weight:500;transition:none;border-bottom:1px solid #d3d3d3;", " border-left:10px solid #d3d3d3;cursor:pointer;box-shadow:10px 10px 8px 10px #000000;"], _shared_helpers__WEBPACK_IMPORTED_MODULE_3__["wideFont"]);
...
})(["display:inline-block;width:30%;padding:8px;padding-top:13px;padding-left:12px;font-size:15px;color:#939ca5;border-bottom:2px solid #d3d3d3;@media (max-width:550px){font-size:13px;}"]);
...
//# sourceMappingURL=dashboard.js.30f13a34cba851cc9744.hot-update.js.map