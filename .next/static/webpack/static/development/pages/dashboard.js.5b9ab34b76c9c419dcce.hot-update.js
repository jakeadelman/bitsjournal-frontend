                    ...
                    for (var i = 0; i < _this2.state.globalHashActive.length; i++) {
                      ...
                      if (i == _this2.state.globalHashActive.length - 1) {
                        if (newHashActive[0] == undefined) {
                          ...
                          (function () {
                            console.log("HASH CLICKED BACK - REMOVING HASH");
                            var newHash2 = [];
                ...
                if (this.state.globalHashActive[_i] == "all") {
                  ...
                  if (_index > -1) {
                    (function () {
                      ...
                      for (var _j = 0; _j < newGlobalHash.length; _j++) {
                        if ("all" == newGlobalHash[_j]) {
                          torf = true;
                        }

                        if (_j == newGlobalHash.length - 1 && torf == false) {
...
//# sourceMappingURL=dashboard.js.5b9ab34b76c9c419dcce.hot-update.js.map