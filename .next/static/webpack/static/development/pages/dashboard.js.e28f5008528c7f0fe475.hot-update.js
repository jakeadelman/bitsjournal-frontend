...
})(["width:100%;display:flex;flex-direction:row;height:52px;font-weight:500;transition:none;border-top:1px solid #d3d3d3;border-bottom:1px solid #d3d3d3;", " border-left:10px solid #d3d3d3;cursor:pointer;box-shadow:10px 10px 8px 10px #000000;"], _shared_helpers__WEBPACK_IMPORTED_MODULE_3__["wideFont"]);
...
})(["display:inline-block;width:30%;padding:8px;padding-top:14px;padding-left:12px;font-size:14px;color:#a1a8b0;@media (max-width:550px){font-size:13px;}"]);
...
//# sourceMappingURL=dashboard.js.e28f5008528c7f0fe475.hot-update.js.map