...
function (_React$Component) {
  ...
  _createClass(CandleStickChartWithAnnotation, [{
    ...
    value: function render() {
      ...
      var _xScaleProvider = xScaleProvider(data),
          chartData = _xScaleProvider.chartData,
        ...
        if (each.side == "Buy") {
          ...
          var annotationPropsDown = {
            ...
            y: function y(_ref2) {
              ...
              return yScale.range()[0]; // yScale.range()[0] *
              // findYValSell(
              //   this.state.yRangeNums[0],
              //   this.state.yRangeNums[1],
              //   each.price
...
//# sourceMappingURL=dashboard.js.5cb4bb602f3fe6867035.hot-update.js.map