      ...
      for (var i = 0; i < this.state.globalHashActive.length; i++) {
        ...
        if (i == this.state.globalHashActive.length - 1) {
          ...
          if (_index2 > -1) {
            ...
            var _newDat = Object(_helpers__WEBPACK_IMPORTED_MODULE_4__["getNewDat"])(this.state.data, _newGlobalHashActive);
...
//# sourceMappingURL=dashboard.js.45b2ddd0d01aacd6cc48.hot-update.js.map