    ...
    value: function componentWillMount() {
      ...
      if (this.state.data[0].side == "Buy" && this.state.data[0].execType == "Trade") {
        ...
        for (var i = 0; i < this.state.data.length; i++) {
          ...
          if (this.state.data[i].orderType == "Limit") {
            totCommission += realQty * 0.0075;
          }

          if (this.state.data[i].orderType == "Market") {
            totCommission += realQty * 0.0025;
          }
      ...
      if (this.state.data[0].side == "Sell" && this.state.data[0].execType == "Trade") {
        ...
        for (var _i2 = 0; _i2 < this.state.data.length; _i2++) {
          ...
          if (this.state.data[_i2].orderType == "Limit") {
            _totCommission += _realQty * 0.0075;
          }

          if (this.state.data[_i2].orderType == "Market") {
            _totCommission += _realQty * 0.0025;
          }
...
//# sourceMappingURL=dashboard.js.f2bd66400eaef00467e3.hot-update.js.map