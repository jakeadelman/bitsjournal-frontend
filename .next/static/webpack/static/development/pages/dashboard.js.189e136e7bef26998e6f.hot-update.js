...
})(["width:100%;display:flex;flex-direction:row;height:52px;font-weight:500;", " &:hover{transition:none;border-left:1px solid black;cursor:pointer;}"], _shared_helpers__WEBPACK_IMPORTED_MODULE_3__["wideFont"]);
...
})(["width:100%;display:flex;flex-direction:row;height:52px;font-weight:500;transition:none;border-bottom:1px solid #d3d3d3;", " border-left:2px solid black;cursor:pointer;box-shadow:10px 10px 8px 10px #000000;"], _shared_helpers__WEBPACK_IMPORTED_MODULE_3__["wideFont"]);
...
})(["display:inline-block;width:30%;padding:8px;padding-top:13px;padding-left:12px;font-size:15px;color:#939ca5;border-bottom:1px solid #d3d3d3;@media (max-width:550px){font-size:13px;}"]);
...
})(["display:inline-block;width:30%;padding:5px;padding-left:13px;padding-top:10px;", " color:#a1a8b0;font-size:12px;"], _shared_helpers__WEBPACK_IMPORTED_MODULE_3__["smallFont"]);
...
})(["display:inline-block;width:30%;color:#78838e;font-weight:600;display:inline-block;text-transform:uppercase;padding:10px;padding-left:12px;font-size:14px;"]);
...
//# sourceMappingURL=dashboard.js.189e136e7bef26998e6f.hot-update.js.map