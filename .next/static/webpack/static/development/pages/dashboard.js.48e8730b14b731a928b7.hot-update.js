    ...
    value: function componentWillMount() {
      ...
      if (this.state.data[0].side == "Buy" && this.state.data[0].execType == "Trade") {
        ...
        for (var i = 0; i < this.state.data.length; i++) {
          ...
          if (this.state.data[i].orderType.includes("Limit")) {
            totCommission += realQty * 0.0075;
          }

          if (this.state.data[i].orderType.includes("Market")) {
...
//# sourceMappingURL=dashboard.js.48e8730b14b731a928b7.hot-update.js.map