...
function (_React$Component) {
  ...
  function Example(props) {
    ...
    _this.handleChange = function (date) {
      ...
      if (_this.props.start == true) {
        _this.props.store.startDate = date.toISOString();
        _this.props.store.date = "Custom";
      }

      if (_this.props.start == false) {
        _this.props.store.endDate = date.toISOString();
        _this.props.store.date = "Custom";
      }
    };
...
//# sourceMappingURL=dashboard.js.fb01a26aee117ed2a2d8.hot-update.js.map