...
/* harmony import */ var _stores_store__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../stores/store */ "./stores/store.js");
...
function (_React$Component2) {
  ...
  _createClass(Comp, [{
    ...
    value: function getGlobalHashtags(data) {
      for (var i = 0; i < data.fetchTradeHistory; i++) {
        var thisTradeHash = data.fetchTradeHistory[i].split(",");

        if (thisTradeHash != "undefined") {
          for (j = 0; j < thisTradeHash.length; j++) {
            if (j != "undefined") {
              Object(_stores_store__WEBPACK_IMPORTED_MODULE_10__["pushGlobalHash"])(j);
            }
          }
        }
      }
...
//# sourceMappingURL=dashboard.js.63be59899ee4a8d5fad5.hot-update.js.map