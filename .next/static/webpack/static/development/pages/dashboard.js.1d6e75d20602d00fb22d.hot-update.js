...
function (_React$Component) {
  ...
  _createClass(Example, [{
    ...
    value: function componentDidUpdate(props, prevProps) {
      if (prevProps.set != props.set) {
        console.log("not equal");
      }

      if (this.props.start == true) {
        this.props.store.startDate = date.toISOString();
        this.props.store.date = "Custom";
      }

      if (this.props.start == false) {
        this.props.store.endDate = date.toISOString();
        this.props.store.date = "Custom";
      }
    }
  }, {
...
//# sourceMappingURL=dashboard.js.1d6e75d20602d00fb22d.hot-update.js.map