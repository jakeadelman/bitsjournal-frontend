              ...
              case 0:
                if (value == "all") {
                  ...
                  (function () {
                    ...
                    for (var _i = 0; _i < _this2.state.globalHashActive.length; _i++) {
                      if (value !== _this2.state.globalHashActive[_i]) {
                        newHashActive.push(_this2.state.globalHashActive[_i]);
                      } else {
                        newHash.push(_this2.state.globalHashActive[_i]);
                      }

                      if (_i == _this2.state.globalHashActive.length - 1) {
...
//# sourceMappingURL=dashboard.js.0661f1ce2e1dc3c400c2.hot-update.js.map