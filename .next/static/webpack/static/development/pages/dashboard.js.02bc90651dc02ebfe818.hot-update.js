        ...
        if (each.side == "Buy") {
          ...
          var annotationPropsDown = {
            ...
            y: function y(_ref2) {
              ...
              // yScale.range()[0] *
              return;
              Object(_helpers__WEBPACK_IMPORTED_MODULE_8__["findYValSell"])(_this.state.yRangeNums[0], _this.state.yRangeNums[1], each.price);
            },
            onClick: console.log.bind(console),
            tooltip: function tooltip(d) {
              return Object(d3_time_format__WEBPACK_IMPORTED_MODULE_3__["timeFormat"])("%B")(d.date);
...
//# sourceMappingURL=dashboard.js.02bc90651dc02ebfe818.hot-update.js.map