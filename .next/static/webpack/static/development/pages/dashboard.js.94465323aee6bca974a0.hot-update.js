        ...
        if (each.side == "Buy") {
          var annotationPropsUp = {
            ...
            y: function y(_ref) {
              ...
              return (// yScale.range()[0] *
                Object(_helpers__WEBPACK_IMPORTED_MODULE_8__["findYValBuy"])(_this.state.yRangeNums[0], _this.state.yRangeNums[1], each.price)
              );
            },
          ...
          var annotationPropsDown = {
            ...
            y: function y(_ref2) {
              ...
              // return yScale.range()[0];
              yScale.range()[0] * Object(_helpers__WEBPACK_IMPORTED_MODULE_8__["findYValSell"])(_this.state.yRangeNums[0], _this.state.yRangeNums[1], each.price);
            },
            onClick: console.log.bind(console),
            tooltip: function tooltip(d) {
              return Object(d3_time_format__WEBPACK_IMPORTED_MODULE_3__["timeFormat"])("%B")(d.date);
...
//# sourceMappingURL=dashboard.js.94465323aee6bca974a0.hot-update.js.map