  ...
  _createClass(Comp, [{
    ...
    value: function hashtagClicked(value) {
      ...
      for (var i = 0; i < this.state.globalHashActive.length; i++) {
        if (value == globalHashActive[i]) {
          return;
        }

        if (globalHashActive.length == 0) {
          globalHashActive.push(value);
          return;
        }

        if (i == globalHashActive.length - 1) {
          globalHashActive.push(value);
          console.log(globalHashActive);
          return;
        }
      }
    }
...
//# sourceMappingURL=dashboard.js.ac09993487e311d6d0b2.hot-update.js.map