        ...
        if (each.side == "Buy") {
          var annotationPropsUp = {
            ...
            y: function y(_ref) {
              ...
              return yScale.range()[0] * Object(_helpers__WEBPACK_IMPORTED_MODULE_8__["findYValBuy"])(_this.state.yRangeNums[0], _this.state.yRangeNums[1], each.price); // return (
              //   yScale.range()[0] *
              //   findYValBuy(
...
//# sourceMappingURL=dashboard.js.084f9a08383f05bbb0b7.hot-update.js.map