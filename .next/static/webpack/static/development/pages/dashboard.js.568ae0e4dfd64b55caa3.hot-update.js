...
})(["width:100%;display:flex;flex-direction:row;height:52px;border-bottom:1px solid #d3d3d3;border-left:5px solid black;cursor:pointer;box-shadow:10px 10px 8px 10px #000000;font-weight:500;"]);
...
})(["display:inline-block;width:30%;padding:10px;padding-left:12px;font-size:15px;font-weight:200;background-color:#f8f8ff;color:#000;@media (max-width:550px){font-size:13px;}"]);
...
//# sourceMappingURL=dashboard.js.568ae0e4dfd64b55caa3.hot-update.js.map